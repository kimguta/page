...
.on({
    'focusout': function() {
       $('.lang-wrap .ibtn').removeClass('active').focus();
    }
}, '.lang-view a:last')
.on({
    'click': function(e) {
        e.preventDefault();
       $('.Hsearch-bx').addClass('active');
       $('.Hsearch-bx input').focus();
    }
}, '#header .search-btn')
.on({
    'click focusout': function(e) {
        e.preventDefault();
       $('.Hsearch-bx').removeClass('active');
